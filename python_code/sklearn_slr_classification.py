...
if __name__ == '__main__':
    ...
    # new hyperparams -- 3
    make_forest_and_export(df, slr_rcp26_5step, yrs_rcp26, "rcp26", "./forests/new_hyperparams_3_",
                           "./forests/forest_performance/new_hyperparams_3_")
    make_forest_and_export(df, slr_rcp85_5step, yrs_rcp85, "rcp85", "./forests/new_hyperparams_3_",
                           "./forests/forest_performance/new_hyperparams_3_")
